...
function Content(props){
    ...
    return(
        <Wrapper>
            ...
            <Btn imgSrc='./assets/icons/back_arrow.png' marginTop="20vh" marginLeft="-36vw" onClick={left_move_comp}/>
            <Btn imgSrc='./assets/icons/arrow.png' marginTop="20vh" marginLeft="36vw" onClick={right_move_comp}/>
